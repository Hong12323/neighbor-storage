          ...
          {item.locationLat && item.locationLng && (
            <View style={styles.descSection}>
              ...
              {item.locationAddress && (
                <Text style={{ fontSize: 13, color: Colors.textSecondary, marginBottom: 8, fontFamily: "NotoSansKR_400Regular" }}>
                  {item.locationAddress}
                </Text>
              )}
              <LocationMap
                lat={parseFloat(item.locationLat)}
                lng={parseFloat(item.locationLng)}
