            ...
            return (
              <Pressable key={record.id} style={styles.rentalCard}>
                ...
                <View style={styles.rentalInfo}>
                  ...
                  {record.isDelivery && record.riderUserId && record.status === "renting" && (
                    <Pressable
                      style={styles.trackingBtn}
                      onPress={() =>
                        router.push({
                          pathname: "/delivery-tracking",
                          params: { rentalId: record.id.toString(), itemTitle: item?.title || "물건" },
                        } as any)
                      }
                    >
                      <Ionicons name="navigate" size={12} color={Colors.white} />
                      <Text style={styles.trackingBtnText}>배달 추적</Text>
                    </Pressable>
                  )}
                </View>
              </Pressable>
